...
+------------------------------------------------------------------------+
|                     Physical Laptop Host Machine                       |
+------------------------------------------------------------------------+
| (VirtualBox NAT Engine)
v
+------------------------------------------------------------------------+
|             Primary Host: Ubuntu 22.04 LTS (IP: 10.0.2.15)              |
|  +--------------------------------+---------------------------------+  |
|  | Management Server (The Brain)  | KVM Hypervisor Agent (Muscle)   |  |
|  | - Port 8080 UI Engine          | - Libvirt Core Orchestrator     |  |
|  | - MySQL Cloud DB Instance      | - Linux Bridge Network (cloud0) |  |
|  +--------------------------------+---------------------------------+  |
+------------------------------------------------------------------------+
|                                            |
| (Orchestrates Local Compute/Storage)       | (Mounts Storage)
v                                            v
+---------------------------------------+   +----------------------------+
|        System Virtual Machines        |   |    Local NFS Loopbacks     |
|  +---------------------------------+  |   |  +----------------------+  |
|  |  Secondary Storage VM (SSVM)    |  |   |  |   Primary Storage    |  |
|  |  - Pulls Images & ISO blue prints|  |   |  | (/export/primary)   |  |
|  +---------------------------------+  |   |  +----------------------+  |
|  |     Console Proxy VM (CPVM)     |  |   |  |  Secondary Storage   |  |
|  |  - Direct VNC Web-GUI Streaming |  |   |  | (/export/secondary)  |  |
|  +---------------------------------+  |   |  +----------------------+  |
+---------------------------------------+   +----------------------------+
|
v
+------------------------------------------------------------------------+
|                  Nested Isolated User Instances                        |
|  [ Guest Instance: Ubuntu 22.04 Server Live Node | Allocation: 2GB RAM] |
+------------------------------------------------------------------------+
